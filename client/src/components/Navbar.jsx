...
const Navbar = ({ toggleSideNav }) => {
  ...
  return (
    <div className="navbar shrink-0 items-center max-w-4xl mx-auto h-28 flex flex-row justify-between border-b-1 border-y-neutral-200 shadow-md shadow-neutral-500 px-8 rounded-t-md">
